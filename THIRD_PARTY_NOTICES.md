...
Substantially adapted into RPMC (see docs/PROVENANCE.md):
...
Design inspiration from Computask (RPMC-authored code):
...
Substantially adapted into RPMC:

- `cleanCredential` placeholder stripping

Design inspiration from WYRE (RPMC-authored code):
...
RPMC did not copy generated Go source. Servosity was used as live-API intelligence and query-shape **validation/reference only**.
